 ...
 *
 *   mkdir -p ~/Projects/html-in-canvas
 *   cp docs/examples/04-html-in-canvas.tsx ~/Projects/html-in-canvas/index.tsx
 *   dapi open ~/Projects/html-in-canvas
 *
 * Frameyard's bundled Chromium supports the html-in-canvas API. The <html> children are
