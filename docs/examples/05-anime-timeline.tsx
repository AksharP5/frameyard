 ...
 *
 *   mkdir -p ~/Projects/anime-timeline
 *   cp docs/examples/05-anime-timeline.tsx ~/Projects/anime-timeline/index.tsx
 *   cd ~/Projects/anime-timeline
 *   npm install animejs
 *   dapi open ~/Projects/anime-timeline
 *
 * Uses Frameyard's html-in-canvas API (see 04-html-in-canvas.tsx). A paused anime.js
