...
| `frameRate` | `number` | Sequence metadata, otherwise `30` | Overrides the frame rate of a numbered image sequence. Encoded video carries its own rate (see [media.md](./media.md#image-sequences)). |
