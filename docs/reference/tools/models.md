...
Frameyard's default local mode returns `{ "models": [] }`. This catalog is for a
separately configured hosted build and does not list models available through
the in-app Codex or Claude Code Assistant.
