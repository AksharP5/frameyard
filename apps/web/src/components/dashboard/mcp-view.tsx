...
function DashboardAgentsSection() {
  ...
  return (
    <DashboardTitledSection
      title="Agents"
      description="Connect to Frameyard’s MCP server to create and edit videos with your agents."
      action={
  ...
  return (
    <DashboardTitledSection title="MCP Server">
      ...
      <p class="px-2 pt-3 text-xs text-muted-foreground">
        <span>Available locally while Frameyard is running. </span>
...
function DashboardCliSection() {
  ...
  return (
    <DashboardSurfaceSection
      title="CLI"
      description="Give agents access to Frameyard through terminal commands."
    >
      <DashboardInfoActionRow
        layout="inline"
        leadingSize="sm"
        ...
        description="Frameyard’s command-line tool for accessing its media tools and managing projects."
        action={
          <Switch>
            <Match when={!status()}>
