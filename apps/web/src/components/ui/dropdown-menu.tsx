    ...
    >
      <span class="pointer-events-none absolute left-0 flex size-6 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <Icon name="confirm-check" class="size-6 text-current" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {props.children}
    </DropdownMenuPrimitive.CheckboxItem>
...
export const DropdownMenuRadioItem = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      ...
      class={cx(
        "group data-[highlighted]:bg-primary data-[highlighted]:text-primary-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        props.class,
      )}
      {...rest}
    >
