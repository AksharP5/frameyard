...
export const buttonVariants = cva({
  base: [
    tw`inline-flex items-center justify-center gap-0 whitespace-nowrap rounded-md font-450 text-xs transition-colors duration-150 motion-reduce:transition-none shrink-0 outline-none`,
