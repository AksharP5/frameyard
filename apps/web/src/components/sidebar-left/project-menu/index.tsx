...
export function ProjectMenu(props: { wordmark?: boolean } = {}) {
  ...
  return (
    <>
      <DropdownMenu placement="bottom-start">
        ...
        >
          <Icon name="frameyard" class="size-6" /><Show when={props.wordmark}><span class="focus-wordmark">frameyard</span></Show>
