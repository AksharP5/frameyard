...
import { splitAtPlayhead, trimSelectionAtPlayhead } from "@/engine";
  ...
  return (
    <>
      ...
      <DropdownMenuGroup>
        ...
        <DropdownMenuItem onSelect={() => trimSelectionAtPlayhead(world, 'in')}>
          Trim left to playhead
          <DropdownMenuShortcut>Q</DropdownMenuShortcut>
        </DropdownMenuItem>
        <DropdownMenuItem onSelect={() => trimSelectionAtPlayhead(world, 'out')}>
