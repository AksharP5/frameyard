...
import { AssetVideoPreview } from "./asset-preview";
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger
        ...
        onContextMenu={() => { setIsHovered(false); props.onSelect(); }}>
        <div
          ref={ref}
        ...
        >
          ...
          <Show when={isVisible() && isHovered() && !isRenaming() && props.asset.type === "VIDEO"}>
            <AssetVideoPreview asset={props.asset} />
          </Show>
