 ...
 */
function currentValue(world: World, target: Entity, property: AnimatableProperty): number | string | number[] | null {
  const path = trackPropertyPath(target, property);
  if (!path) return null;
 ...
 */
export function writeKeyframe(world: World, editor: DocumentEditor, target: Entity, property: AnimatableProperty, value?: number | string | number[]): Entity | null {
 ...
 */
export function syncKeyframe(world: World, editor: DocumentEditor, target: Entity, property: AnimatableProperty, value: number | string | number[]): void {
