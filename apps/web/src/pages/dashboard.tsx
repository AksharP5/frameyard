...
function parseView(value: string | string[] | undefined): DashboardView {
  ...
  if (localMode && raw && !["home", "projects", "settings", "mcp", "help"].includes(raw)) return "home";
          ...
          <Show
            ...
            fallback={
              <DashboardSidebarSection>
                ...
                <DashboardSidebarItem active={view() === "projects"} onClick={() => setView("projects")} icon="folders-icon" label="Projects" />
              </DashboardSidebarSection>
            }
          >
            <DashboardSidebarSection>
