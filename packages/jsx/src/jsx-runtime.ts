...
export declare namespace JSX {
  ...
  export interface IntrinsicElements extends HtmlElementTags, SvgElementTags {
    ...
    scene3d: Scene3DProps & SourceProps;
    mesh: MeshProps & SourceProps;
    path3d: Path3DProps & SourceProps;
    pointCloud: PointCloudProps & SourceProps;
    light: LightProps & SourceProps;
    volume: VolumeProps & SourceProps;
    ...
    highlight: HighlightProps & SourceProps;
    preset: PresetProps & SourceProps;
