...
import type {
  ...
  PathProps,
  EllipseProps,
  SceneProps, Scene3DProps, MeshProps, Path3DProps, PointCloudProps, LightProps, VolumeProps,
  SequenceProps,
  ShaderPaintProps,
  ShadowProps,
  SolidPaintProps,
...
export const Highlight = hostElement<HighlightProps>("Highlight");
export const Preset = hostElement<PresetProps>("Preset");
...
export const Scene3d = hostElement<Scene3DProps>("Scene3d");
export const Mesh = hostElement<MeshProps>("Mesh");
export const Path3d = hostElement<Path3DProps>("Path3d");
export const PointCloud = hostElement<PointCloudProps>("PointCloud");
export const Light = hostElement<LightProps>("Light");
export const Volume = hostElement<VolumeProps>("Volume");
