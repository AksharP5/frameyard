...
import { groupBy, findActiveCaptionGroup, splitSequence, clearTextRanges, resolveTranscript, setChars } from './utils';
...
export class GuineaCaptionDecoder implements CaptionDecoder {
	...
	public seekTo(world: World, entity: Entity, relativeTime: number): void {
		...
		if (group !== this.currentGroup || activeSplit !== this.activeSplit) {
