...
import { parsePresetOptions, parseHighlightOptions, type AssetRef, type PathProps, type DepthSortMode } from '@diffusionstudio/jsx';
...
export const PathData = trait({ value: "", fillRule: "nonzero" as NonNullable<PathProps["fillRule"]>, viewBox: () => undefined as PathProps["viewBox"] });
...
export const DepthSort = trait({ value: "layer" as DepthSortMode });
...
// A timed Group whose image comes from the composited underlay, never a media decoder.
