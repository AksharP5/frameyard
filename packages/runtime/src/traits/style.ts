...
// Surface treatment samples the already-composited content behind a layer.
export const LayerMaterial = trait({ backdropBlur: 0, refraction: 0 });

export const SceneEffects = trait({
  bloom: 0,
  vignette: 0,
  grain: 0,
  colorSplit: 0,
