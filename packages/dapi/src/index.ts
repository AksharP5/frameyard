...
export { AgentToolContentItem } from "./tools/agent-tool";
...
import type { AgentToolContentItem as AgentToolContentItemSchema } from "./tools/agent-tool";
...
export type AgentToolContent = z.output<typeof AgentToolContentItemSchema>;
...
export type AgentToolRequest = ToolArgs<"agent_tool">;
export type AgentToolResult = ToolOutput<"agent_tool">;
